...
for dat,ax in zip(((s,'Original Image'),(reshape_estimate,'computed Hurst exponent'),(retour,'Hurst exponent after JH2 minisation'),(gaussian_filter(reshape_estimate,1),'Smothed computed Hurst exponent with Gaussian kernel')), axes.flat):
  im = ax.imshow(dat[0])
  ax.set_title(dat[1])
